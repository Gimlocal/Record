...
단계별로 하나씩 설명해보겠습니다.    
영상 앞부분에 슬라임이 합쳐지고 분열하는 큰 슬라임이 나오는 연출부터 확인해보겠습니다.    
...
여기에 사용된 패턴은 무한 상태머신으로, 보통 보스몹의 AI를 구현하기 위해 사용되는 패턴입니다.    
이 패턴은 말 그대로 플레이어와 보스가 전투중일 때 무한정으로 패턴을 뽑아내기 위한 패턴입니다.     
